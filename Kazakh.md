...
- Ауқымы: 500 толық аниме франшизасы, фильмдері мен OVA-лары, жалпы 4,598 бөлім және 41,377+ субтитр файлы (.srt, .vtt, .ass).
...
**Ж:** Осы GitHub репозиторийінен тікелей немесе jsDelivr CDN арқылы кез келген ойнатқышқа (VLC, MPV, PotPlayer) немесе сайтқа қоса аласыз. Каталогта ikymory аударған 500 аниме мен 4,598 бөлім бар.
